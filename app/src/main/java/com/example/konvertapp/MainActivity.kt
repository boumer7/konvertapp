// You are free to modify the copies of this document but not the document itself
// (hardfork is allowed)
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        TranslateButton.setOnClickListener {
            ...
            //https://therules.ru/hard-sign/ (твёрдый знак информация)

            ReverseButton.setOnClickListener {

            ExtractedInput = ExtractedInput.replace("A","А")

            ExtractedInput = ExtractedInput.replace("B","Б")

            ExtractedInput = ExtractedInput.replace("V","В")

            ExtractedInput = ExtractedInput.replace("G","Г")

            ExtractedInput = ExtractedInput.replace("D","Д")

            ExtractedInput = ExtractedInput.replace("YE","Е")

            ExtractedInput = ExtractedInput.replace("YO","Ё")

            ExtractedInput = ExtractedInput.replace("ZH","Ж")

            ExtractedInput = ExtractedInput.replace("Z","З")

            ExtractedInput = ExtractedInput.replace("I","И")

            ExtractedInput = ExtractedInput.replace("Y","Й")

            ExtractedInput = ExtractedInput.replace("K","К")

            ExtractedInput = ExtractedInput.replace("L","Л")

            ExtractedInput = ExtractedInput.replace("M","М")

            ExtractedInput = ExtractedInput.replace("N","Н")

            ExtractedInput = ExtractedInput.replace("O","О")

            ExtractedInput = ExtractedInput.replace("P","П")

            ExtractedInput = ExtractedInput.replace("R","Р")

            ExtractedInput = ExtractedInput.replace("S","С")

            ExtractedInput = ExtractedInput.replace("T","Т")

            ExtractedInput = ExtractedInput.replace("U","У")

            ExtractedInput = ExtractedInput.replace("F","Ф")

            ExtractedInput = ExtractedInput.replace("H","Х")

            ExtractedInput = ExtractedInput.replace("C","Ц")

            ExtractedInput = ExtractedInput.replace("CH","Ч")

            ExtractedInput = ExtractedInput.replace("SH","Ш")

            ExtractedInput = ExtractedInput.replace("SCH","Щ")

            ExtractedInput = ExtractedInput.replace("Y","Ы")

            ExtractedInput = ExtractedInput.replace("'","Ь")

            ExtractedInput = ExtractedInput.replace("E","Э")

            ExtractedInput = ExtractedInput.replace("YU","Ю")

            ExtractedInput = ExtractedInput.replace("YA","Я")
